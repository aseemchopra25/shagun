...
export default (parent, text) => (sketch) => {
  ...
  const fillDots = (width, height) => {
    ...
    if (width > height) {
      ...
      secondWordPoints = font.textToPoints(thirdWord, width * 0.05, height * 0.83, width * 0.27);
    } else {
      ...
      thirdWordPoints = font.textToPoints(thirdWord, width * 0.01, height * 0.7, width * 0.27);
    }
